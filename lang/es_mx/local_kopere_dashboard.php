...
$string['dashboard_enrol_text'] = 'Ha sido inscrito en el curso <a href="?classname=courses&method=details&courseid={$a->courseid}">{$a->fullname}</a> y';
...
$string['userimport_event_import_course_enrol_subject'] = 'Bienvenido - {[course.fullname]}';
...
$string['userimport_event_import_user_created_and_enrol_subject'] = 'Bienvenido - {[course.fullname]}';
